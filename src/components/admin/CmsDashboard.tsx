...
import { Loader2, FileText, CheckCircle, FileEdit } from 'lucide-react';
    ...
    useEffect(() => {
        const fetchStats = async () => {
            try {
                ...
                setStats({ totalPosts: tPosts, publishedPosts: pubPosts, draftPosts: drfPosts });
            } catch (e) {
    ...
    return (
        <div>
            ...
            <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {[
                    { label: 'Novo Post', href: '/admin/posts/new', desc: 'Escrever e publicar um novo post', color: 'violet' },
                    { label: 'Ver Posts', href: '/admin/posts', desc: 'Gerenciar todos os posts', color: 'slate' },
